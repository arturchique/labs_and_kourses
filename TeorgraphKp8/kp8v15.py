...
matrix_size_entry = Entry(root, width=200)
first_page_btn = Button(root, text="Ввести", command=confirm_count, width=200)
second_page_btn = Button(root, text="Вывести все контуры", command=confirm_matrix, width=200)
